...
from .views_jobs import MockJobDetailView, MockJobListView, MockJobSaveAsJdView


urlpatterns = [
    path('worknet/jobs', WorknetJobSearchView.as_view(), name='worknet-job-search'),
    path('jobs', MockJobListView.as_view(), name='mock-jobs'),
    path('jobs/<str:job_id>/save-jd', MockJobSaveAsJdView.as_view(), name='mock-job-save-jd'),
