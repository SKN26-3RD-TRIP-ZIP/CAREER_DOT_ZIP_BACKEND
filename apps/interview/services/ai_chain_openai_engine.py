...
KOREAN_SUFFICIENCY_SIGNAL_MARKERS = {
...
class AIChainOpenAIEngine:
    ...
    def _calculate_answer_sufficiency_signals(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        for key, markers in KOREAN_SUFFICIENCY_SIGNAL_MARKERS.items():
            signals[key] = signals[key] or self._contains_any(answer_text, markers)
